...
class Button extends React.Component<ButtonProps, ButtonState> {
    ...
    render() {
        ...
        const classes = cx('component-button', className, {
            ...
            [`component-button--size-${size}`]: size,
            'component-button--block': block,
            'component-button--disabled': isLoading || disabled,
            'component-button--rounded': rounded,
            'component-button--outline': outline,
            'component-button--roundless': roundless,
            'component-button--borderless': borderless,
            'component-button--has-navigation': navigationHref,
            'component-button--transparent': transparent,
        })

        const isDisabled = isLoading || isLoadingState || disabled
        ...
        return (
            ...
            >
                ...
                {arrow && (
                    <ArrowDownIcon
                        className={cx('component-button__arrow-icon')}
                    />
                )}
                {navigationHref && (
                    <Link
