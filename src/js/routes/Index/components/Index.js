...
class IndexViewBase extends React.Component {
  ...
  render() {
    ...
    const { render, renderAction1, renderAction2, renderAction3 } = this.state
        ...
        {({ history: { push } }) => (
          <PageContent
            className={cx('route--index', {
              'route--index--active': !disableHeader && !disableFooter,
            })}
          >
            <div className={cx('route--index__container')}>
              {render && [
                ...
                <div className={cx('route--index__container__actions')}>
                  ...
                  {renderAction3 && (
                    <ComponentsButton setLayoutOption={setLayoutOption} />
                  )}
                </div>,
              ]}
            </div>
...
const ContactMeButton = () => (
  ...
  >
    ...
    <Popover.Content className={cx('animation--swing-in-top-fwd')}>
      {({ close }) => <ContactFormContainer type="popover" close={close} />}
    </Popover.Content>
  </Popover.Container>
)
