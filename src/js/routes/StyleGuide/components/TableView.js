                ...
                <Row>
                  <Col xs={12}>
                    ...
                    >
                      <Table.THead>
                        <Table.Row>
                          <Table.Th xs={3}>Test 1</Table.Th>
                          <Table.Th xs={3}>Test 2</Table.Th>
                          <Table.Th xs={3}>Test 3</Table.Th>
                          <Table.Th xs={3}>Test 4</Table.Th>
                        </Table.Row>
                      </Table.THead>
                      <Table.TBody>
                        <Table.Row>
                          <Table.Td xs={3}>Test 1</Table.Td>
                          <Table.Td xs={3}>Test 2</Table.Td>
                          <Table.Td xs={3}>Test 3</Table.Td>
                          <Table.Td xs={3}>Test 4</Table.Td>
                        </Table.Row>
                        <Table.Row>
                          <Table.Td xs={3}>Test 1</Table.Td>
                          <Table.Td xs={3}>Test 2</Table.Td>
